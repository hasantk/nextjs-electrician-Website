...
const formSchema = z.object({
  name: z.string().min(2, { message: "İsim Alanını Boş Bırakmayın." }),
  email: z.string().email({ message: "Geçerli Mail Adresi Yazın." }),
  message: z.string().min(10, { message: "Mesajınızı Yazın." }),
